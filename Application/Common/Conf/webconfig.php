...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  '鲁ICP备17030487号',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  '1903087169@qq.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  '城南旧事',             //网站名：
    'WEB_KEYWORDS'              =>  '城南旧事,杨鹏,杨小鹏,技术博客,个人博客,Yuri',         //网站关键字
    'WEB_DESCRIPTION'           =>  '杨鹏的个人技术博客',      //网站描述
    'AUTHOR'                    =>  'Yuri',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为杨鹏原创文章,转载无需和我联系,但请注明来自白城南旧事www.杨鹏.com',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  '城南旧事', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'Yuri',      //文字水印内容
