<?php
 return array (
  ...
  array (
    ...
    'addtime' => 'int(10) NOT NULL default "0"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `cid` (`cid`),KEY `title` (`title`),KEY `sort` (`sort`),KEY `addtime` (`addtime`)',
  ),
  'baobei' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `uid` (`uid`),KEY `huan_goods_id` (`huan_goods_id`)',
  ),
  'duoduo2010' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `cid` (`cid`),UNIQUE KEY `iid` (`iid`),KEY `title` (`title`),KEY `nick` (`nick`),KEY `sort` (`sort`),KEY `addtime` (`addtime`),KEY `tuijian` (`tuijian`),KEY `baoyou` (`baoyou`)',
  ),
  'huan_goods' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `cid` (`cid`),KEY `title` (`title`),KEY `hide` (`hide`),KEY `sort` (`sort`),KEY `sdate` (`sdate`),KEY `edate` (`edate`)',
  ),
  'huodong' => 
  array (
    'id' => 'int(10) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `pay_time` (`pay_time`),KEY `num_iid` (`num_iid`),UNIQUE KEY `trade_id` (`trade_id`),KEY `checked` (`checked`),KEY `uid` (`uid`),KEY `mini_trade_id` (`mini_trade_id`)',
  ),
  'tuan_goods' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),UNIQUE KEY `ddusername` (`ddusername`),KEY `loginnum` (`loginnum`),KEY `lastlogintime` (`lastlogintime`),KEY `alipay` (`alipay`),UNIQUE KEY `email` (`email`),KEY `money` (`money`),KEY `jifenbao` (`jifenbao`),KEY `jifen` (`jifen`),KEY `txstatus` (`txstatus`),KEY `dhstate` (`dhstate`),KEY `level` (`level`),KEY `tjr` (`tjr`),KEY `mobile` (`mobile`),KEY `ucid` (`ucid`),KEY `tbtxstatus` (`tbtxstatus`),KEY `platform` (`platform`),KEY `trade_uid` (`trade_uid`)',
  ),
  'user_temp' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
