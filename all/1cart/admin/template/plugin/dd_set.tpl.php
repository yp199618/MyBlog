...
?>
  <tr>
    ...
    <td>&nbsp;<?=html_radio(array(0=>'关闭',1=>'开启'),$plugin['status']?$plugin['status']:0,'status')?> <a href="<?=u(MOD,'update',array('code'=>$plugin['code'],'plugin_id'=>$plugin_id,'do'=>'update','over'=>1))?>">更新</a>（同步应用信息，会更新应用版本号）</td>
  </tr>
  ...
  <tr>
    ...
    <td>&nbsp;<input name="search_width" type="text" id="search_width" value="<?=$plugin_set['search']['search_width']?>" style="width:300px" /> （单位：像素）</td>
  </tr>
  <tr>
