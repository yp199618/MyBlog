      ...
      <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
					...
					<?php foreach ($row as $r){?>
					  <tr>
                        ...
                        <?php }else{?>
                        <a href="<?=u(MOD,'update',array('code'=>$r['code'],'do'=>'uninstall'))?>" onclick="return confirm('卸载同时会删除插件相关数据，确定要卸载？')" class=link4>卸载</a>
                        <?php }?>
                        <?php if($r['banben']>=PLUGIN_2){?>
                        <a href="<?=u(MOD,'file',array('code'=>$r['code']))?>" class=link4>查看文件</a>
                        <?php }?>
