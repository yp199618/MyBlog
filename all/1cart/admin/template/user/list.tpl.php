...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB">
        <tr>
              <td width="300px">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<?php if($webset['taoapi']['auto_fanli']==1){?><a href="<?=u(MOD,ACT,array('trade_uid'=>1,'page'=>1))?>" class="link3">[提取淘宝订单会员id]</a> <a class="link3" href="<?=u('buy_log','list')?>">[淘宝浏览记录]</a><?php }?></td>
