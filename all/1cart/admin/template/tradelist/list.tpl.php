...
<form action="" method="get">
  <table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB">
    <tr>
      <td width="300px" class="bigtext">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<a <?php if($tiqu_mini==1){?>title="提取mini订单后才能导入订单"<?php }else{?>href="<?=u('tradelist',$_act)?>"<?php }?> class="link3">[<?=$_act_name?>]</a> <a href="<?=u(MOD,'addedi')?>" class="link3">[添加订单]</a> <?php if($tiqu_mini==1){?><a href="<?=u(MOD,ACT,array('mini'=>1,'page'=>1))?>" style="color:#F00; font-weight:bold" class="link3">[提取mini订单号]</a><?php }?></td>
...
<form name="form2" method="get" action="" style="margin:0px; padding:0px">
  <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
    <tr>
      ...
      <th width="4%">积分</th>
      <th width="<?=(TAOTYPE==1)?'70px':'130px'?>">结算时间</th>
      <th width="6%">认领</th>
      <?php if(TAOTYPE==1){?>
      <th width="65px">状态</th>
